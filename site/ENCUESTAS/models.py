...
('Asistencia alimentaria (por ejemplo, bancos de alimentos).', 'Asistencia alimentaria (por ejemplo, bancos de alimentos).'),
...
('Programas de apoyo a familias en situación de vulnerabilidad.', 'Programas de apoyo a familias en situación de vulnerabilidad.'),
...
('Programas de inclusión y apoyo a inmigrantes y refugiados.', 'Programas de inclusión y apoyo a inmigrantes y refugiados.'),
( 'Apoyo espiritual para el sector penitenciario y carcelario.', 'Apoyo espiritual para el sector penitenciario y carcelario.'),
...
('COLABORACION_VARIOS_PROYECTOS', 'Sí, hemos colaborado en varios proyectos comunitarios con organizaciones no religiosas.'),
('COLABORACION_ALGUNOS_PROYECTOS', 'Sí, hemos colaborado en algunos proyectos comunitarios con organizaciones no religiosas.'),
('NO_COLABORACION_ORGANIZACIONES_NO_RELIGIOSAS', 'No, no hemos colaborado con organizaciones no religiosas en proyectos comunitarios.'),
('NO_SEGURO_NO_APLICABLE', 'No estoy seguro/No aplicable.'),
]

###  21.
OPCIONES_CAMBIO_DEMOGRAFIA = [
('CAMBIOS_NOTADOS', 'Sí, hemos notado cambios en la demografía y las creencias religiosas de la población a lo largo del tiempo. ¿Cuáles?'),
('SIN_CAMBIOS_SIGNIFICATIVOS', 'No, no hemos notado cambios significativos en la demografía o las creencias religiosas de la población.'),
('NO_SEGURO_NO_APLICABLE', 'No estoy seguro/No aplicable.'),
]
...
('NO_COLABORACION', 'No, no colaboramos con otras organizaciones religiosas o no religiosas en proyectos o iniciativas.'),
('NO_SEGURO_NO_APLICABLE', 'No estoy seguro/No aplicable.'),
]
...
('TOMA_DECISIONES_PARTICIPATIVA', 'Fomentando la toma de decisiones participativa en la planificación de actividades.'),
...
('APOYO_RECURSOS_TALENTOS', 'Brindando apoyo y recursos para el desarrollo de talentos y habilidades de la comunidad.'),
('PLATAFORMAS_EN_LINEA_COMUNICACION', 'Utilizando plataformas en línea o redes sociales para la comunicación y participación.'),
...
('PARTICIPACION_LOCAL', 'Sí, nuestros líderes participan activamente en instancias locales de participación, como consejos de vecinos o juntas de acción comunal.'),
('PARTICIPACION_LOCAL_NACIONAL', 'Sí, nuestros líderes participan en instancias locales y nacionales de participación, como comités ciudadanos o asambleas.'),
('PARTICIPACION_NACIONAL', 'Sí, nuestros líderes participan en instancias nacionales de participación, como organizaciones religiosas a nivel nacional o coaliciones interreligiosas.'),
...
('RELACION_NEUTRAL', 'El gobierno local tiene una relación neutral con la entidad religiosa, sin interacciones significativas.'),
...
('RESTRICCIONES_SIGNIFICATIVAS', 'La entidad local presenta restricciones significativas a la libertad de culto y religión.'),
('NO_SEGURO_NO_APLICABLE', 'No estoy seguro/No aplicable.'),
]
###  35
...
('ASISTENCIA_SOCIAL', 'Realizando programas de asistencia social para quienes lo necesitan.'),
('PLATAFORMAS_EN_LINEA_REDES_SOCIALES', 'Utilizando plataformas en línea o redes sociales para interactuar con la comunidad.'),
('NO_INTERACCION', 'No interactuamos activamente con la comunidad local.'),
('NO_SEGURO_NO_APLICABLE', 'No estoy seguro/No aplicable.'),
]
###  43
...
('SERVICIOS_ESPECIFICOS', 'Sí, ofrecemos servicios religiosos o de apoyo a grupos específicos, como niños, jóvenes o personas mayores. ¿Cuáles?'),
('ABIERTO_TODA_COMUNIDAD', 'No, nuestros servicios religiosos son abiertos a toda la comunidad sin distinción de grupos específicos.'),
...
('INVITACIONES_COMUNICACIONES', 'A través de invitaciones y comunicaciones regulares a los miembros de la comunidad.'),
...
('FORMACION_GRUPOS_COMITES', 'Facilitando la formación de grupos y comités de interés.'),
('APOYO_RECURSOS_DESARROLLO_TALENTOS', 'Brindando apoyo y recursos para el desarrollo de talentos y habilidades de la comunidad.'),
('PLATAFORMAS_EN_LINEA_REDES_SOCIALES', 'Utilizando plataformas en línea o redes sociales para la comunicación y participación.'),
('NO_PROMUEVE_PARTICIPACION', 'No promovemos activamente la participación de la población local en nuestras actividades sociales.'),
('NO_SEGURO_NO_APLICABLE', 'No estoy seguro/No aplicable.'),
]
...
('PROYECTOS_EDUCACION', 'Proyectos de educación para promover la igualdad de género y el acceso a la educación de calidad.'),
('INICIATIVAS_SALUD', 'Iniciativas de salud para mejorar el bienestar y la atención médica de comunidades vulnerables.'),
('PROGRAMAS_ALIMENTACION_NUTRICION', 'Programas de alimentación y nutrición para combatir la malnutrición y el hambre.'),
('PROYECTOS_VIVIENDA', 'Proyectos de vivienda y desarrollo de infraestructura para reducir la desigualdad en el acceso a la vivienda adecuada.'),
('PROGRAMAS_EMPRENDIMIENTO', 'Programas de empoderamiento económico para combatir la pobreza y promover el empleo digno.'),
...
('NO_ACTIVIDADES_ESPECIFICAS_ODS', 'No hemos llevado a cabo actividades específicas relacionadas con los ODS en Colombia.'),
('NO_SEGURO_NO_APLICABLE', 'No estoy seguro/No aplicable.'),
]
###  47.1
...
('ACTIVIDADES_ARTISTICAS_LUDICAS_DEPORTIVAS', 'Actividades artísticas, lúdicas o deportivas que aporten a la construcción de la paz.'),
...
('TRABAJO_PROTECCION_GARANTIA_DERECHOS_DIVERSIDAD_ETNICA_CULTURAL', 'Trabajo en protección/garantía de derechos de la diversidad étnica y cultural.'),
('OBJECION_CONCIENCIA', 'Objeción de conciencia.'),
('PREVENCION_TRABAJO_VIOLENCIA_COTIDIANA_RIÑAS_CALLEJERAS', 'Prevención o trabajo en temas de violencia cotidiana/riñas callejeras.'),
]
###  48
...
('SI_COLABORA_OCASIONALMENTE', 'Sí, colabora ocasionalmente con agencias gubernamentales en proyectos humanitarios en Colombia.'),
('SI_COLABORA_CON_ORGANIZACIONES_NO_RELIGIOSAS', 'Sí, colabora con organizaciones no religiosas en proyectos humanitarios en Colombia.'),
...
('EVENTOS_TALLERES_ABIERTOS', 'Organizamos eventos y talleres abiertos a la comunidad para fomentar la participación y la colaboración.'),
('COORDINACION_ORGANIZACIONES_COMUNITARIAS', 'Trabajamos en estrecha coordinación con organizaciones comunitarias existentes en Colombia.'),
...
('comunidades_indigenas', 'Sí, nuestras actividades humanitarias están dirigidas principalmente a comunidades indígenas o afrocolombianas.'),
('desastres_naturales', 'Sí, nos centramos en brindar servicios a personas afectadas por desastres naturales en Colombia.'),
...
('REUNIONES_ASAMBLEAS_ABIERTAS', 'Organizamos reuniones y asambleas abiertas a la comunidad para recoger sus opiniones y sugerencias sobre nuestras actividades humanitarias.'),
('GRUPOS_VOLUNTARIOS_LOCALES', 'Establecemos grupos de voluntarios locales que colaboran activamente en la implementación de proyectos.'),
('COLABORACION_ORGANIZACIONES_COMUNITARIAS', 'Colaboramos estrechamente con organizaciones comunitarias existentes en Colombia para trabajar de manera conjunta en proyectos humanitarios.'),
('PARTICIPACION_COMUNIDAD_TOMA_DECISIONES', 'Promovemos la participación de la comunidad en la toma de decisiones relacionadas con nuestros proyectos humanitarios a través de consultas y encuestas.'),
...
('CAMBIOS_LEGISLACION_POLITICAS', 'Cambios en la legislación o políticas gubernamentales que afectan nuestras actividades.'),
...
('INCREMENTAR_RECAUDACION_FONDOS', 'Incrementar nuestros esfuerzos de recaudación de fondos para financiar proyectos a largo plazo.'),
('MEJORAR_PARTICIPACION_EMPODERAMIENTO', 'Mejorar la participación y el empoderamiento de la comunidad local en la toma de decisiones.'),
('INVERTIR_FORMACION_CAPACITACION', 'Invertir en la formación y capacitación continua de nuestro personal y voluntarios.'),
...
('BUSCAR_OPORTUNIDADES_PROMOVER_PAZ', 'Buscar oportunidades para promover la paz y la reconciliación en áreas afectadas por conflictos.'),
('TODAS_LAS_ANTERIORES', 'Todas las anteriores.'),
...
('LIMPIEZA_MANTENIMIENTO_REPARACION', 'Limpieza, mantenimiento y reparación (Barrer, trapear, tender camas, sacudir el polvo, sacar la basura; Cuidar mascotas o animales de compañía, cuidar el jardín, limpiar el vehículo; Traer combustible para uso de la comunidad diferente a leña; Reparar o hacer instalaciones en otras viviendas diferente a la suya)'),
('CUIDADO_FISICO', 'Cuidado físico como apoyo a integrantes de la comunidad u otras comunidades (Alimentar a una persona o ayudarle a hacerlo; Bañar o vestir a una persona o ayudarle a hacerlo; Suministrar medicamentos, hacer terapias o dar tratamiento a enfermedades)'),
('CUIDADO_NINOS', 'Cuidado de niños, niñas y adolescentes integrantes de su comunidad u otras comunidades (Jugar; Leer o contar cuentos; Llevar al parque)'),
('APOYO_PERSONAS', 'Apoyo a personas de su comunidad u otras comunidades (Ayudar con tareas o trabajos escolares; Acompañar a citas médicas, odontológicas, urgencias, terapias u otras atenciones en salud. Llevar o traer a personas del hogar al sitio de estudio, trabajo o a eventos culturales deportivos o recreativos)'),
('CULTIVO_COSECHA', 'Cultivo y cosecha de productos agrícolas o de huerta/cuidado de animales para el consumo de su comunidad)'),
