...
class Encuesta(models.Model):
   ...
   #####
    ...
    areas_temas_prioridad = MultiSelectField(
        ' ¿Qué áreas o temas sociales son prioritarios para su Entidad (por ejemplo, educación, salud, alimentación, vivienda)?'
        '(puede seleccionar varios)',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_TIPO_ACTIVIDAD)
    ...
    principales_inciativas_sociales = MultiSelectField(
        ' ¿Cuáles son las principales iniciativas o proyectos sociales que la Entidad religiosa ha llevado a cabo en Colombia en los últimos años?'
        '(puede seleccionar varios)',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_TIPO_ACTIVIDAD)
    ...
    cuales_actividades_ods = MultiSelectField(
        '¿Cuáles actividades o proyectos específicos ha llevado a cabo su organización para contribuir a la consecución de los ODS en Colombia?'
        '(puede seleccionar varios)',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_TIPO_ACTIVIDAD)  
    ...
    apoyo_economico_emergencia= models.CharField(
        '¿La Entidad religiosa brinda apoyo económico o asistencia financiera a sus líderes religiosos en caso de enfermedad o emergencia?',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_AUTORIZAR_USO)
    ...
    proporciona_formacion_social= models.CharField(
        '¿Se proporciona algún tipo de formación o capacitación sobre seguridad social y beneficios para líderes religiosos en su Entidad religiosa?',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_AUTORIZAR_USO)
    
    #####
    experimentado_problema_seguridad_social= models.CharField(
        '¿Ha experimentado algún problema o desafío específico relacionado con la seguridad social o los beneficios en su papel como líder religioso??',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_AUTORIZAR_USO)
    

    #####
    beneficios_implementado_seguridad = MultiSelectField(
        '¿Qué tipo de beneficios o apoyo adicional le gustaría ver implementado o mejorado en su Entidad religiosa en relación con la seguridad social?'
        '(puede seleccionar varios)',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_TIPO_ACTIVIDAD)  
    ...
    colabora_agencias_humanitarios= models.CharField(
        '¿Colabora su organización religiosa con agencias gubernamentales u organizaciones no religiosas en proyectos humanitarios en Colombia?',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_AUTORIZAR_USO)
    ...
    interactua_comunidad_humanitario = MultiSelectField(
        '¿¿Cómo interactúa su organización religiosa con la comunidad local en Colombia en relación con el actuar humanitario?'
        '(puede seleccionar varios)',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_TIPO_ACTIVIDAD)  
    ...
    principales_desafios_humanitarios = MultiSelectField(
        '¿Cuáles son los principales desafíos que enfrenta su organización religiosa en Colombia en la actualidad en relación con su actuación humanitaria?'
        '(puede seleccionar varios)',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_TIPO_ACTIVIDAD)  
    ...
    realiza_cuidados_comunidad = MultiSelectField(
        '¿Habitualmente realiza alguna de las siguientes actividades de cuidado dirigidos a otros hogares o a su comunidad?'
        '(puede seleccionar varios)',
        blank=True, null=True, max_length=255, default="", choices=OPCIONES_TIPO_ACTIVIDAD)  
